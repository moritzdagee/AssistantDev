...
- Der bereitgestellte Token `ZMkTf0ZqYs5tw2q8` wird vom Server mit HTTP 401 abgelehnt (Endpoint existiert, Token ungueltig/abgelaufen). **Moritz muss einen frischen Bot-Token** in der kChat Integrations-Seite erzeugen und in `models.json['kchat']['auth_token']` eintragen.
